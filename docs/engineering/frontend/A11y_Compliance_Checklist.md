...
Accessibility in FerroUI is non-negotiable and non-bypassable. Because the AI generates layouts dynamically, a11y cannot be left to developer diligence on a per-screen basis. This checklist ensures all components and generated layouts meet WCAG 2.1 Level AA standards.

---

## 2. Compliance Levels

| Level | Description | FerroUI Requirement |
|-------|-------------|---------------------|
