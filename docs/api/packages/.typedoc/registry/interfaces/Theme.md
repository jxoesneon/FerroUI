...
> `optional` **component?**: [`ComponentTokens`](ComponentTokens.md)

#### primitive?

> `optional` **primitive?**: [`PrimitiveTokens`](PrimitiveTokens.md)

#### semantic?

> `optional` **semantic?**: [`SemanticTokens`](SemanticTokens.md)
