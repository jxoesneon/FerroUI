...
> **completePrompt**(`req`): `Promise`\<[`LlmResponse`](LlmResponse.md)\>
...
> **processPrompt**(`req`): `AsyncGenerator`\<`string`, [`LlmResponse`](LlmResponse.md), `undefined`\>
...
`AsyncGenerator`\<`string`, [`LlmResponse`](LlmResponse.md), `undefined`\>
